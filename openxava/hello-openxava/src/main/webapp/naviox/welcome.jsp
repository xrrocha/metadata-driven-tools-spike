...
In hello-openxava-labels_en.properties:
hello-openxava=My application
hello-openxava[description]=My application does this and that

In hello-openxava-messages_en.properties:
